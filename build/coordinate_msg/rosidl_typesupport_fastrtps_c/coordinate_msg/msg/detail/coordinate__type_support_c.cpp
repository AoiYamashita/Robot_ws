...
#include "coordinate_msg/msg/detail/coordinate__rosidl_typesupport_fastrtps_c.h"
...
#include "coordinate_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Coordinate__ros_msg_type = coordinate_msg__msg__Coordinate;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_coordinate_msg
size_t get_serialized_size_coordinate_msg__msg__Coordinate(
  const void * untyped_ros_message,
...
static uint32_t _Coordinate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_coordinate_msg__msg__Coordinate(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_coordinate_msg
size_t max_serialized_size_coordinate_msg__msg__Coordinate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Coordinate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_coordinate_msg__msg__Coordinate(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, coordinate_msg, msg, Coordinate)() {
